...
const Plan = () => {
  return (
    <div className='max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4'>
      <div className='grid grid-cols-2 object-cover w-full h-full p-2'>
      <img
      ...
      <div className='flex flex-col h-full justify-center'>
        ...
        <p className='text-2xl py-6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Id, explicabo.</p>
        <p className='pb-6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur nostrum labore officia facilis similique? Rerum illum beatae doloribus possimus facere aut fuga odio tempore autem.</p>
        <div>
            <button className='border-black mr-4 hover:shadow-xl transition-all duration-150'>Learn More</button>
            <button className='border-black mr-4 hover:shadow-xl transition-all duration-150'>Book Your Trip</button>
        </div>
      </div>
    </div>
  )
